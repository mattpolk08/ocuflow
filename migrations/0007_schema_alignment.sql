...
ALTER TABLE patients ADD COLUMN IF NOT EXISTS address_country              TEXT DEFAULT 'US';
ALTER TABLE patients ADD COLUMN IF NOT EXISTS home_phone                   TEXT;
ALTER TABLE patients ADD COLUMN IF NOT EXISTS allergies_json               TEXT DEFAULT '[]';
ALTER TABLE patients ADD COLUMN IF NOT EXISTS current_medications_json     TEXT DEFAULT '[]';
ALTER TABLE patients ADD COLUMN IF NOT EXISTS insurance_plans_json         TEXT DEFAULT '[]';
...
ALTER TABLE appointments ADD COLUMN IF NOT EXISTS checked_out_at    TEXT;
...
ALTER TABLE lenses ADD COLUMN IF NOT EXISTS index_value   REAL;
ALTER TABLE lenses ADD COLUMN IF NOT EXISTS sphere_min    REAL;
ALTER TABLE lenses ADD COLUMN IF NOT EXISTS sphere_max    REAL;
ALTER TABLE lenses ADD COLUMN IF NOT EXISTS cylinder_max  REAL;
...
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS frame_id      TEXT;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS frame_sku     TEXT;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS frame_brand   TEXT;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS frame_model   TEXT;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS frame_color   TEXT;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS lens_id       TEXT;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS lens_sku      TEXT;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS lens_name     TEXT;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS lens_type     TEXT;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS od_sphere     REAL;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS od_cylinder   REAL;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS od_axis       INTEGER;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS od_add        REAL;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS od_pd         REAL;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS os_sphere     REAL;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS os_cylinder   REAL;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS os_axis       INTEGER;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS os_add        REAL;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS os_pd         REAL;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS binocular_pd  REAL;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS coating       TEXT;
ALTER TABLE optical_orders ADD COLUMN IF NOT EXISTS tint          TEXT;

-- ── optical_rx ───────────────────────────────────────────────────────────────
-- Missing: updated_at (SELECT * in lib code will error without it)
ALTER TABLE optical_rx ADD COLUMN IF NOT EXISTS updated_at TEXT;
